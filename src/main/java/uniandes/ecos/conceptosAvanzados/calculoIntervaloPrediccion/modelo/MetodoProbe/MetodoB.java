...
public class MetodoB extends MetodoProbe implements IMetodoProbe {
	 ...
	 */
	public MetodoB(ArrayList<ModelViewArchivoIntervaloPrediccion> archivoIntervaloPrediccion, TipoEstimacion tipoEstimacion, int estimadoProxy) {
	...
	private void llenarEstimacionLoc(ArrayList<ModelViewArchivoIntervaloPrediccion> archivoIntervaloPrediccion) {
		for (int indice = 0; indice < archivoIntervaloPrediccion.size(); indice ++) {
			double datoProxy = archivoIntervaloPrediccion.get(indice).darPlanAddedAndModifiedSize();
